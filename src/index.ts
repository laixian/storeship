...
export { checkShots, MAX_SLOTS, MAX_TILT, type CheckFs } from './shots/check.ts'
export { pngSize, findChrome, shoot, sheet } from './shots/render.ts'
export { expand, layout, deviceBox, screenShort, screensOf, HERO_SEAM, HERO_TILT } from './shots/layout.ts'
export { paintSlot } from './shots/paint.ts'
export { deviceHtml, bodyCss } from './shots/body.ts'
export { STYLES, DEFAULT_STYLE, extendStyle, resolveTheme } from './shots/styles/index.ts'
export * as styleKit from './shots/styles/common.ts'
export { stageFor, renderSet } from './shots/run.ts'
export { loadShots, resolveStyle, type ShotsSetup } from './shots/load.ts'
/** Identity, for type checking a content file: `export default defineShots({ style, frames })`. */
export const defineShots = <T extends import('./shots/types.ts').ShotsContent>(c: T): T => c
